...
Подробную информацию о реализации сложных методов, включая конкретные строки данных для SetOption, названия способностей и режимы нацеливания, см. в документации (docs).
